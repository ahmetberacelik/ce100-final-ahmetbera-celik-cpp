...
reportgenerator "-title:Hometracker Library Documentation Coverage Report (Linux)" "-reports:**/lcov_doxygen_lib_linux.info" "-targetdir:docs/coverxygenliblinux" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_lib_hist_linux"
...
reportgenerator "-title:Hometracker Library Test Documentation Coverage Report (Linux)" "-reports:**/lcov_doxygen_test_linux.info" "-targetdir:docs/coverxygentestlinux" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_test_hist_linux"
...
./publish_linux/bin/hometracker_tests
./publish_linux/bin/hometrackerapp
...
cp -R src/hometracker/header build_linux/build/Release
...
cp -R src/hometracker/header build_linux/build/Debug
