...
call reportgenerator "-title:Hometracker Library Documentation Coverage Report (Windows)" "-reports:**/lcov_doxygen_lib_win.info" "-targetdir:docs/coverxygenlibwin" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_lib_hist_win"
...
call reportgenerator "-title:Hometracker Library Test Documentation Coverage Report (Windows)" "-reports:**/lcov_doxygen_test_win.info" "-targetdir:docs/coverxygentestwin" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_test_hist_win"
...
echo Generate Test Coverage Data for Hometracker
call OpenCppCoverage.exe --export_type=binary:hometracker_tests_unit_win.cov --sources src\hometracker\src --sources src\hometracker\header --sources src\tests\hometracker -- build_win\build\Debug\hometracker_tests.exe

echo Generate Test Coverage Data for Hometracker App and Combine Results
call OpenCppCoverage.exe --input_coverage=utility_tests_unit_win.cov --input_coverage=hometracker_tests_unit_win.cov --export_type=cobertura:hometrackerapp_unit_win_cobertura.xml --sources src\utility\src --sources src\utility\header --sources src\hometracker\src --sources src\hometracker\header --sources src\hometrackerapp\src --sources src\hometrackerapp\header --sources src\tests\utility --sources src\tests\hometracker -- build_win\build\Debug\hometrackerapp.exe

echo Generate Unit Test Coverage Report
call reportgenerator "-title:Hometracker Library Unit Test Coverage Report (Windows)" "-targetdir:docs/coveragereportlibwin" "-reporttypes:Html" "-reports:**/hometrackerapp_unit_win_cobertura.xml" "-sourcedirs:src/utility/src;src/utility/header;src/hometracker/src;src/hometracker/header;src/hometrackerapp/src;src/hometrackerapp/header;src/tests/utility;src/tests/hometracker" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*" "-historydir:report_test_hist_win"
call reportgenerator "-targetdir:assets/codecoveragelibwin" "-reporttypes:Badges" "-reports:**/hometrackerapp_unit_win_cobertura.xml" "-sourcedirs:src/utility/src;src/utility/header;src/hometracker/src;src/hometracker/header;src/hometrackerapp/src;src/hometrackerapp/header;src/tests/utility;src/tests/hometracker" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*"
...
call robocopy src\hometracker\header "build_win\build\Release" /E
call robocopy src\hometrackerapp\header "build_win\build\Release" /E
...
call robocopy src\hometracker\header "build_win\build\Debug" /E
call robocopy src\hometrackerapp\header "build_win\build\Debug" /E
